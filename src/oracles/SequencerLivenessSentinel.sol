...
/// https://github.com/euler-xyz/euler-price-oracle/blob/experiments/src/wrapper/SequencerLivenessSentinel.sol
...
contract SequencerLivenessSentinel is IPriceOracle {
    ...
    constructor(
        address _wrappedOracle,
        address _chainlinkSequencerUptimeFeed,
    ...
    function _checkLiveness() internal view {
        ...
        (, int256 answer, uint256 startedAt,,) =
            AggregatorV3Interface(chainlinkSequencerUptimeFeed).latestRoundData();
