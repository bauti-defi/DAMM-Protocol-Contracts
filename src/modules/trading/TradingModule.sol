...
contract TradingModule is ITradingModule, ReentrancyGuard {
    ...
    modifier notPaused() {
        if (paused) revert Errors.ModulePaused();
        _;
    }
        ...
        notPaused
    {
        ...
        if (transactionCount == 0) revert Errors.InvalidTransactionLength();
